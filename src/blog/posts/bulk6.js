...
// 3B-1 Pilot: enrich 15 B-tier articles with original useful content (800-1200w where justified)
// Remove generic boilerplate, add specific sections, contextual links, no placeholder
(function enrichPilot(){
  const enrichMap = {
    'retro-bowl-how-to-play-online': `<p>Retro Bowl is a retro football game where you coach and play as quarterback. You call plays, throw passes, and manage a roster across a season. This guide shows how to start quickly and avoid the menus that confuse new players.</p><h2>How to Start Your First Season</h2><p>Pick any team, keep difficulty on Normal, and play the first preseason game. You will learn the flow: pick a play on the left, then control the action on the field. The game auto-saves after each week, so you can stop after one game. Don\'t worry about contracts in week one — focus on learning one running play and one short passing play.</p><h2>Controls</h2><p><strong>Desktop:</strong> Mouse to pick plays, click and drag to aim a pass, arrow keys to move the runner. <strong>Mobile:</strong> Tap to pick, swipe to aim. On both, the aiming line shows where the ball will go. Short drags are more accurate than long flicks.</p><h2>What Happens Each Week</h2><p>After the game you see morale, fan support, and contract screens. Wins raise morale, which makes players perform better. Losses lower it. Extending a happy player early is cheaper than waiting until they demand more. You don\'t need to understand every stat on day one.</p><h2>Common Mistakes</h2><ul><li>Trying long passes on every play. Short slants on 3rd and short keep drives alive.</li><li>Ignoring offensive line. A weak line makes both run and pass harder.</li><li>Forgetting to extend young players before they become stars.</li></ul><p>When you are ready, <a href="/en/g/retro-bowl">Play Retro Bowl</a> and run your first season. Next read <a href="/blog/retro-bowl-tips-and-strategies">Retro Bowl Tips</a> or try a different pace with <a href="/en/g/drift-boss">Drift Boss</a>.</p>`,
    'retro-bowl-tips-and-strategies': `<p>Retro Bowl looks simple, but winning consistently needs good habits. These strategies focus on play-calling and roster, not motivation quotes.</p><h2>Win With Short Passing</h2><p>On 3rd and 5 or less, a 5-yard slant beats a 20-yard bomb. A completion keeps the drive alive and keeps morale up. Save deep shots for 1st down when the defense expects run.</p><h2>Build the Roster Smart</h2><p>Prioritize wide receiver speed and offensive line strength. A fast receiver with average hands will separate and score more than a slow one with great hands. On defense, a decent secondary prevents the 40-yard touchdowns that swing games.</p><h2>Clock Management</h2><p>Use the whole play clock when leading late. Don\'t snap quickly; let time run before the next play. On defense, you don\'t control the clock, so your offense must protect the lead.</p><p>Related: <a href="/en/g/retro-bowl">Play Retro Bowl</a> — <a href="/blog/retro-bowl-how-to-play-online">How to Play Retro Bowl</a></p>`,
    'retro-bowl-advanced-guide': `<p>This guide is for coaches who already make the playoffs but want back-to-back titles. It is about cap and postseason decisions, not basic controls.</p><h2>Cap Management</h2><p>Extend second-year players after a good season, before they become stars. Their price jumps after a Pro Bowl year. Keep role players on one-year deals so you can cut them if a rookie is better. Don\'t keep a 32-year-old star at top salary if a 24-year-old does 90% for half the price.</p><h2>Seeding vs Health</h2><p>If you have clinched the division with two games left, rest your quarterback and top receiver for a half. A healthy roster in the wildcard round matters more than moving from seed 3 to seed 2.</p><h2>Playoff Adjustments</h2><p>In playoffs, teams play tighter coverage. Have one short, high-percentage play you trust on 3rd down, and one safe run for 2 yards. Turnovers end seasons.</p><p><a href="/en/g/retro-bowl">Play Retro Bowl</a> — <a href="/blog/retro-bowl-tips-and-strategies">Tips and Strategies</a></p>`,
    'drift-boss-how-to-play-online': `<p>Drift Boss uses one input: hold to steer right, release to steer left. The track is narrow and never ends, so the skill is rhythm, not speed.</p><h2>How to Play</h2><p>The car rolls forward automatically. Tap and hold Space (or mouse) to turn right, release to turn left. The longer you hold, the sharper the turn. Stay on the platform — falling ends the run. Coins on the track unlock new cars.</p><h2>Controls</h2><p><strong>Desktop:</strong> Space or mouse hold. <strong>Mobile:</strong> Tap and hold. That is the whole scheme. Release timing is the only skill.</p><h2>Learning the Corners</h2><p>Wide corners need a long hold, tight corners need short taps. Look two corners ahead, not at the car. If you stare at the car, you will over-correct.</p><p><a href="/en/g/drift-boss">Play Drift Boss</a> — see also <a href="/blog/drift-boss-tips-and-strategies">Drift Boss Tips</a></p>`,
    'drift-boss-tips-and-strategies': `<p>Turning a 30-point run into 100+ is about repeating a rhythm. These tips are specific to Drift Boss, not generic “stay focused”.</p><h2>Find the Beat</h2><p>Most sections follow tap-tap-hold. Count it quietly: “one-two-hold”. Once you feel it, the track seems slower.</p><h2>Car Choice</h2><p>Unlocked cars are not strictly better. The green coupe is slower but more stable, which helps you learn. Switch to faster cars only after you can consistently hit 80+.</p><h2>Recovery</h2><p>If you are near the edge, release completely for a half-second. The car will straighten and give you a chance to re-center. Holding while panicking guarantees a fall.</p><p><a href="/en/g/drift-boss">Play Drift Boss</a></p>`,
    'drift-boss-advanced-guide': `<p>At high scores the track tightens and bonuses matter. This guide covers multipliers and car collection.</p><h2>Score Multipliers</h2><p>Every clean corner without edge correction adds to the multiplier shown at the top. A 10-corner clean section pays more than two risky shortcuts. Prioritize staying centered over cutting corners.</p><h2>Coins and Unlocks</h2><p>Coins appear in lines that pull you slightly off the ideal line. Take them only if they don\'t force a sharp correction on the next corner. One coin is not worth ending a 80-point run.</p><p><a href="/en/g/drift-boss">Play Drift Boss</a></p>`,
    'monkey-mart-how-to-play-online': `<p>Monkey Mart is a store management game. You are the monkey who stocks shelves, runs the register, and expands the market. Customers arrive continuously and buy whatever is nearest the entrance.</p><h2>How to Play</h2><p>Move with WASD, pick up boxes with Space, and drop goods on empty shelves. When customers want an item, they walk to it and pay automatically at the register. Use earnings to buy new aisles, fridges, and staff.</p><h2>First Upgrades</h2><p>Hire the cashier as soon as you can afford it. It frees you from standing at the register and lets you focus on stocking. After that, upgrade the banana shelf — it sells fastest.</p><p><a href="/en/g/monkey-mart">Play Monkey Mart</a></p>`,
    'monkey-mart-tips-and-strategies': `<p>Monkey Mart gets busy fast. Efficiency beats speed.</p><h2>Layout</h2><p>Put bananas, milk, and eggs closest to the entrance. Less popular items go in the back. This shortens the average customer walk and keeps the front from clogging.</p><h2>Staff Timing</h2><p>Hire the stocker only after you have three aisles. Before that, you can restock faster yourself. The stocker is slow at first and shines when there is more to do.</p><p><a href="/en/g/monkey-mart">Play Monkey Mart</a></p>`,
    'stickman-hook-how-to-play-online': `<p>Stickman Hook is a swinging game where you hook onto anchors and launch between platforms. The fun is in keeping momentum without over-swinging.</p><h2>How to Hook</h2><p>Click and hold to attach the string, release to let go. The stickman swings like a pendulum. Release near the bottom of the swing to go farthest.</p><h2>Controls</h2><p><strong>Desktop:</strong> Click to hook. <strong>Mobile:</strong> Tap. No other keys are needed. Timing matters more than power.</p><h2>Common Error</h2><p>Holding too long. If you stay attached past the bottom, you swing back and lose speed. Small, quick hooks beat big, slow ones.</p><p><a href="/en/g/stickman-hook">Play Stickman Hook</a></p>`,
    'stickman-hook-tips-and-strategies': `<p>Keeping momentum is the whole game. These tips help when the platforms get small and spaced.</p><h2>Keep the Chain Taut</h2><p>A loose chain wastes energy. Hook, swing, release, then hook the next anchor quickly. Two short swings beat one huge swing that overshoots.</p><h2>When Stuck</h2><p>If you stop on a platform, walk to the edge, hook the next anchor from the edge, not the middle. Starting from the edge gives you more swing distance.</p><p><a href="/en/g/stickman-hook">Play Stickman Hook</a></p>`,
    'blocky-blast-puzzle-how-to-play-online': `<p>Blocky Blast Puzzle gives you three blocks at a time and a 10×10 board. Your job is to place them so complete rows or columns disappear.</p><h2>How to Play</h2><p>Drag a block onto the board. If a full row or column is filled, it clears. The game ends when none of the three blocks can fit anywhere.</p><h2>Opening Strategy</h2><p>Keep the center four squares open as long as possible. The center is where most blocks can fit, so filling it early creates dead ends.</p><p><a href="/en/g/blocky-blast-puzzle">Play Blocky Blast Puzzle</a></p>`,
    'blocky-blast-puzzle-tips-and-strategies': `<p>High scores come from planning, not speed. These strategies avoid the typical early loss at ~2,000 points.</p><h2>Look Ahead</h2><p>Before placing, look at all three blocks, not just the one you are holding. Place the awkward L-shapes first, save the 1×1 and 2×1 for fixing holes.</p><h2>Center Rule</h2><p>Try to keep at least one 3×3 area empty in the middle until you have no choice. That empty area saves you when you get three large blocks in a row.</p><p><a href="/en/g/blocky-blast-puzzle">Play Blocky Blast Puzzle</a></p>`,
    'level-devil-how-to-play-online': `<p>Level Devil is a platformer that lies to you. Every level looks normal until a spike appears where you just stepped, a ceiling falls, or the ground disappears.</p><h2>How to Play</h2><p>Move with arrows, jump with Space. The first run through a level is reconnaissance. Die, remember where the trap was, and adjust the next run. Checkpoints are frequent.</p><h2>What Makes It Different</h2><p>Unlike normal platformers where skill is enough, here memory matters more. The traps are the same each time, so the level is a puzzle you learn by dying.</p><p><a href="/en/g/level-devil">Play Level Devil</a></p>`,
    'level-devil-tips-and-strategies': `<p>Later worlds add moving traps. These tips help when the game starts combining tricks.</p><h2>Move Slowly on Sight</h2><p>When you see a new room, walk to the middle and stop. Many traps trigger at the center, so you will see them before you commit to a jump.</p><h2>Use Deaths as Notes</h2><p>After three deaths on one jump, change your approach completely — jump earlier, later, or not at all. Repeating the same jump is how you stay stuck.</p><p><a href="/en/g/level-devil">Play Level Devil</a></p>`,
    'slope-how-to-play-online': `<p>Slope is a 3D runner where a ball rolls down a neon track that is generated as you go. There is no end — only faster and steeper sections.</p><h2>How to Play</h2><p>Steer left and right to stay on the track and avoid red blocks. The ball accelerates constantly. You control only lateral movement.</p><h2>Controls</h2><p><strong>Desktop:</strong> A/D or Left/Right. <strong>Mobile:</strong> Tilt or swipe. Use tiny inputs — large swerves put you into walls.</p><h2>Survival Priority</h2><p>Don\'t chase every diamond. A diamond that requires a sharp cut across the track is not worth the risk after 50+ speed.</p><p><a href="/en/g/slope">Play Slope</a></p>`
  };
  out.forEach(p=>{
    if(enrichMap[p.slug]){
      p.content = enrichMap[p.slug];
      p.excerpt = p.content.replace(/<[^>]+>/g,' ').slice(0,160) + '...';
      // Remove placeholder image dependency — use no image (clean text)
      p.content = p.content.replace(/<img[^>]*placehold[^>]*>/g,'');
      // Ensure contextual links only (already in enrichMap)
    }
  });
  // Remove generic 5-link boilerplate for pilot posts: ensure no retro-bowl/subway/drive-mad generic block remains
  out.forEach(p=>{
    if(enrichMap[p.slug]){
      // generic block is not present in enrichMap, so nothing to remove
    }
  });
})();
