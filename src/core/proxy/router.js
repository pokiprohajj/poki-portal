...
function cleanPokiBranding(html, sourcePath) {
  ...
  // Phase 8: Replace site navigation logo icon with our custom SVG
  result = result.replace(/--icon-src:\s*url\([^)]*poki\.svg[^)]*\)/gi, "--icon-src: url('/static/img/logo.svg')");
  ...
  if (sourcePath && sourcePath.match(/\/c\/contact/i)) {
    const contactFallback = '<div id="contact-fallback" style="display:none;max-width:800px;margin:80px auto;padding:40px;background:#1a1a2e;border-radius:16px;color:#fff;font-family:-apple-system,BlinkMacSystemFont,\'Segoe UI\',Roboto,sans-serif"><h1 style="font-size:32px;margin-bottom:12px;color:#fff">Contact BrowserGamesHQ</h1><p style="font-size:16px;color:#a0a0c0;margin-bottom:32px;line-height:1.6">We\'d love to hear from you! Reach out to us via email for support, partnerships, or general inquiries.</p><div style="display:flex;gap:16px;flex-wrap:wrap"><a href="mailto:hajjoutiforskype@gmail.com" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#6c5ce7;color:#fff;border-radius:10px;text-decoration:none;font-weight:600">Email Us</a><a href="/en/about-us" style="display:inline-flex;align-items:center;gap:8px;padding:14px 28px;background:#2d2d44;color:#fff;border-radius:10px;text-decoration:none;font-weight:600">About BrowserGamesHQ</a></div><p style="margin-top:32px;font-size:14px;color:#666;border-top:1px solid #2d2d44;padding-top:24px">You can also visit our <a href="/en/about-us" style="color:#6c5ce7;text-decoration:none">About page</a> for more information about BrowserGamesHQ.</p></div><script>document.addEventListener("DOMContentLoaded",function(){var f=document.getElementById("contact-fallback");if(f){setTimeout(function(){if(!document.querySelector("#root > *")){f.style.display="block"}},3000);var mo=new MutationObserver(function(){var e=document.querySelector(\'a[href*="hello@"]\');if(e&&!e.href.includes("hajjoutiforskype"))e.href="mailto:hajjoutiforskype@gmail.com";var n=document.createTreeWalker(document.body,4);while(n.nextNode()){if(n.currentNode.nodeValue&&n.currentNode.nodeValue.includes("hello@poki"))n.currentNode.nodeValue=n.currentNode.nodeValue.replace(/hello\s*@\s*poki\s*\.\s*com/gi,"hajjoutiforskype@gmail.com")}mo.disconnect()});mo.observe(document.body,{childList:true,subtree:true,characterData:true})}});</script>';
    result = result.replace('</head>', '</head>' + contactFallback);
    const contactEmailFix = '<script>document.addEventListener("DOMContentLoaded",function(){var e=document.querySelector(\'a[href*="hello@"]\');if(e&&!e.href.includes("hajjoutiforskype"))e.href="mailto:hajjoutiforskype@gmail.com";var n=document.createTreeWalker(document.body,4);while(n.nextNode()){if(n.currentNode.nodeValue&&n.currentNode.nodeValue.includes("hello@poki"))n.currentNode.nodeValue=n.currentNode.nodeValue.replace(/hello\s*@\s*poki\s*\.\s*com/gi,"hajjoutiforskype@gmail.com")}var f=document.getElementById("contact-fallback");if(f&&f.style.display==="none"){setTimeout(function(){if(!document.querySelector("#root > *")){f.style.display="block"}},3000)}});</script>';
