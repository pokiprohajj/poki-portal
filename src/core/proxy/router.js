...
async function handlePageRequest(req, res) {
  ...
  try {
    ...
    if (isContactPage) {
      ...
      const contactHtml = '<section id="contact-content" style="max-width:800px;margin:40px auto;padding:0 24px;text-align:center"><h1 style="font-size:32px;margin-bottom:8px;color:#fff">Get in touch</h1><p style="font-size:18px;color:#a0a0c0;margin-bottom:8px">We\'d love to hear from you</p><p style="font-size:26px;color:#6c5ce7;font-weight:700;margin-bottom:40px"><span id="contact-email"></span></p><div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap"><a href="/en/c/faq" style="padding:12px 24px;background:#2d2d44;border-radius:10px;color:#fff;text-decoration:none;font-size:14px">Need help? Check FAQ</a><a href="https://developers.browsergameshq.com" style="padding:12px 24px;background:#2d2d44;border-radius:10px;color:#fff;text-decoration:none;font-size:14px">For Developers</a><a href="https://jobs.browsergameshq.com" style="padding:12px 24px;background:#2d2d44;border-radius:10px;color:#fff;text-decoration:none;font-size:14px">Join our team</a></div><script>document.getElementById("contact-email").textContent="hello"+String.fromCharCode(64)+"browsergameshq.com";document.getElementById("contact-email").style.cursor="pointer";document.getElementById("contact-email").onclick=function(){location.href="mailto:hello"+String.fromCharCode(64)+"browsergameshq.com"};</script></section>';
      html = html.replace('<footer', contactHtml + '<footer');
    }
