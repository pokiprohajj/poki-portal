...
async function handlePageRequest(req, res) {
  ...
  try {
    ...
    if (isContactPage) {
      ...
      html = html.replace('</body>', '<style>#contact-content{max-width:800px;margin:40px auto;padding:0 24px;text-align:center}#contact-content h1{font-size:32px;margin-bottom:8px;color:#fff}#contact-content .sub{font-size:18px;color:#a0a0c0;margin-bottom:8px}#contact-content .email{font-size:20px;color:#6c5ce7;font-weight:700;margin-bottom:40px;cursor:pointer;text-align:center;word-break:break-word}@media(max-width:600px){#contact-content h1{font-size:24px}#contact-content .email{font-size:16px}#contact-content{padding:0 16px}}</style><script>document.addEventListener("DOMContentLoaded",function(){var s=document.createElement("section");s.id="contact-content";var em="hello"+String.fromCharCode(64)+"browsergameshq.com",sq=String.fromCharCode(39),h="<h1>Get in touch</h1><p class="+sq+"sub"+sq+">We"+String.fromCharCode(8217)+"d love to hear from you</p><p class="+sq+"email"+sq+">"+em+"</p><div style="+sq+"display:flex;gap:12px;justify-content:center;flex-wrap:wrap"+sq+"><a href="+sq+"/en/c/faq"+sq+" style="+sq+"padding:12px 24px;background:#2d2d44;border-radius:10px;color:#fff;text-decoration:none;font-size:14px"+sq+">Need help? Check FAQ</a><a href="+sq+"https://developers.browsergameshq.com"+sq+" style="+sq+"padding:12px 24px;background:#2d2d44;border-radius:10px;color:#fff;text-decoration:none;font-size:14px"+sq+">For Developers</a><a href="+sq+"https://jobs.browsergameshq.com"+sq+" style="+sq+"padding:12px 24px;background:#2d2d44;border-radius:10px;color:#fff;text-decoration:none;font-size:14px"+sq+">Join our team</a></div>";s.innerHTML=h;s.querySelector(".email").onclick=function(){location.href="mailto:"+em};var f=document.querySelector("footer");if(f)f.parentNode.insertBefore(s,f);else document.body.appendChild(s);var r=document.getElementById("app-root")||document.getElementById("root");if(r&&window.MutationObserver){new MutationObserver(function(){if(!document.getElementById("contact-content")){var s2=s.cloneNode(true);s2.id="contact-content";var f2=document.querySelector("footer");if(f2)f2.parentNode.insertBefore(s2,f2);else document.body.appendChild(s2)}}).observe(r,{childList:true,subtree:true})}});</script></body>');
    }
